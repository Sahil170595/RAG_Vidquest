...
def test_imports():
    ...
    try:
        ...
        print("✅ Video service imported successfully")
...
def test_models():
    ...
    try:
        ...
        print(f"✅ QueryResponse created: {response.query}")
...
def test_video_service():
    ...
    try:
        ...
        print(f"✅ Video service created, find_video_path returned: {result}")
...
def test_data_structure():
    ...
    for subdir in subdirs:
        ...
        if subdir_path.exists():
            ...
            print(f"✅ {subdir}/ directory exists with {file_count} files")
        else:
